...
import in.websnoox.tappTablet.dataReport.wheelAdapter.ABWheelViewAdapter;
 ...
 * 
 */
public abstract class ABWheel extends View {

	/*private static int itemID = -1;
*/
	/*@SuppressWarnings("unused")
	private final String LOG_TAG = ABWheel.class.getName() + " #" + (++itemID);*/
	 ...
	 */
	private static final int DEF_VISIBLE_ITEMS = 14;
	private static final boolean DEF_IS_CYCLIC = true;
	...
	// View adapter
	protected ABWheelViewAdapter mViewAdapter;
	 ...
	 */
	public ABWheel(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs);
	...
	protected void initAttributes(AttributeSet attrs, int defStyle) {
		TypedArray a = getContext().obtainStyledAttributes(attrs,
				R.styleable.ABWheelView, defStyle, 0);
		mVisibleItems = a.getInt(R.styleable.ABWheelView_visibleItems,
				DEF_VISIBLE_ITEMS);
		mIsAllVisible = a.getBoolean(R.styleable.ABWheelView_isAllVisible,
				false);
		mIsCyclic = a.getBoolean(R.styleable.ABWheelView_isCyclic,
				DEF_IS_CYCLIC);
	 ...
	 */
	public ABWheelViewAdapter getViewAdapter() {
		return mViewAdapter;
	}
	 ...
	 *            the view adapter
	 */
	public void setViewAdapter(ABWheelViewAdapter viewAdapter) {
