 ...
 */
public abstract class ABWheelView extends ABWheel {

	private static int itemID = -1;

	@SuppressWarnings("unused")
	private final String LOG_TAG = ABWheelView.class.getName() + " #"
			+ (++itemID);
	...
	protected void initAttributes(AttributeSet attrs, int defStyle) {
		...
		mItemsDimmedAlpha = a.getInt(R.styleable.ABWheelView_itemsDimmedAlpha,
				DEF_ITEMS_DIMMED_ALPHA);
		mSelectionDividerActiveAlpha = a.getInt(
				R.styleable.ABWheelView_selectionDividerActiveAlpha,
				DEF_SELECTION_DIVIDER_ACTIVE_ALPHA);
		mSelectionDividerDimmedAlpha = a.getInt(
				R.styleable.ABWheelView_selectionDividerDimmedAlpha,
				DEF_SELECTION_DIVIDER_DIMMED_ALPHA);
		mItemOffsetPercent = a.getInt(
				R.styleable.ABWheelView_itemOffsetPercent,
				DEF_ITEM_OFFSET_PERCENT);
		mItemsPadding = a.getDimensionPixelSize(
				R.styleable.ABWheelView_itemsPadding, DEF_ITEM_PADDING);
		mSelectionDivider = a
				.getDrawable(R.styleable.ABWheelView_selectionDivider);
		a.recycle();
	}
	...
	protected void onScrollTouchedUp() {
		...
		/*
		 * fadeSelectorWheel(750); lightSeparators(750);
		 */
	}
	...
	protected void onScrollFinished() {
		/*
		 * fadeSelectorWheel(500); lightSeparators(500);
		 */
	}
